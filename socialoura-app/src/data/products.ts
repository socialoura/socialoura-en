...
export const products: Product[] = [
  ...
  },
  {
    ...
    icon: "eye",
    color: "#FF0000",
    description: "Increase your YouTube video authority with high-retention, Data-Backed Engagement. Our AI-powered delivery optimizes watch-time signals to improve search ranking and recommendation placement.",
    deliveryTime: "Smart-Paced Delivery",
    guarantee: "High-Retention Guarantee",
    pricingTiers: [], // Loaded dynamically from database
    features: [
      "Audience Filtering — verified account network",
      "Smart-Paced Delivery — high watch-time retention",
      "High-Retention Guarantee — lifetime stability",
      "Search Ranking & Recommendation Boost",
      "Dedicated Growth Specialists — 24/7",
      "Secure payment",
    ],
  },
